...
export const MultiStepLoader = ({
  ...
  duration?: number;
  loop?: boolean;
  value?: number; // optional external control of current step
}) => {
  const [currentState, setCurrentState] = useState(0);

  useEffect(() => {
    // If not loading or when externally controlled via `value`, don't run the internal timer
      ...
      {loading && (
        ...
        >
          <div className="h-96  relative">
            <LoaderCore
              value={loading ? (typeof value === "number" ? value : currentState) : 0}
